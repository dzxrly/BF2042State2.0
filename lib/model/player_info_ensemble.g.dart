...
WeaponInfoEnsemble _$WeaponInfoEnsembleFromJson(Map<String, dynamic> json) =>
    WeaponInfoEnsemble(
      ...
      json['type'] as String,
      json['hipfireKills'] as int,
      (json['hipfireRate'] as num).toDouble(),
...
Map<String, dynamic> _$WeaponInfoEnsembleToJson(WeaponInfoEnsemble instance) =>
    <String, dynamic>{
      ...
      'hipfireKills': instance.hipfireKills,
      'hipfireRate': instance.hipfireRate,
    };
...
Map<String, dynamic> _$PlayerInfoEnsembleToJson(PlayerInfoEnsemble instance) =>
    <String, dynamic>{
      ...
      'realKillRate': instance.realKillRate,
