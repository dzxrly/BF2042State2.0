...
- Google Play (
  內部測試版，由於內部測試為白名單機制，請先將個人谷歌帳號對應的郵箱發送至aegonhe993@gmail.com以方便將您加入白名單。): [Google Play Internal Test](https://play.google.com/apps/internaltest/4701368484862393507)
...
8. **Q：為什麼沒有玩家等級顯示？**
   ...
   A：`gametools.network`的API並不提供玩家等級的資料。
